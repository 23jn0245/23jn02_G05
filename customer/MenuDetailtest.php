...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'add_to_cart') {
    ...
    // リダイレクトしてメッセージを表示
    header("Location: MenuDetailtest.php?product_id=$product_id");
    exit;
}
?>
...
<body>
    ...
    <div class="container">
        ...
        <div class="btn-row">
            ...
            <button type="button" class="btn-home" onclick="location.href='Toppage.php'">トップページへ</button>
        </div>
    </div>
    ...
    <div class="popup-message">
        ...
        <button class="close-button" onclick="document.querySelector('.popup-message').style.display='none';">閉じる</button>
    </div>
    <?php 
